    ...
    <header>
                        ...
                        <div class="category-dropdown">
                            ...
                            <div class="category-menu" id="categoryDropdown">
                                ...
                                foreach ($categories as $category): ?>
                                    <a class="dropdown-item" href="?act=search&category=<?= urlencode($category['category_id']) ?>">
                                        <i class="fab fa-apple"></i>
                                        <?= htmlspecialchars($category['category_id']) ?> <!-- Display category name -->
                                    </a>
                                <?php endforeach; ?>
                            </div>
                        </div>
        ...
        <script>
            ...
            function toggleCategoryMenu(event) {
                ...
                dropdown.classList.toggle('swhow');
            }
