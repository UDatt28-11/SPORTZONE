            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="index.php?act=edit-Brands&id=<?= $brands['id'] ?>" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-2">
                                        <img src="./uploads/brands/<?= $brands['logo'] ?>" alt="Logo" width="50px">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="status" class="form-label">Trạng Thái</label>
                                    <select class="form-select" name="status">
                                        <option value="1" <?= ($brands['status'] == 1) ? 'selected' : '' ?>>Hiện
                                        </option>
