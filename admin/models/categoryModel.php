...
class Category
{
    ...
    public function addCategory($categoryName, $categoryStatus)
    {
        try {
    ...
    {
        try {
            $sql = 'SELECT * FROM categories WHERE id = :danh_muc_id';
            $stmt = $this->conn->prepare($sql);
    ...
    public function updateCategory($danh_muc_id, $ten_danh_muc, $trang_thai)
    {
        try {
            $sql = 'UPDATE categories SET name = :ten_danh_muc, status = :trang_thai WHERE id = :danh_muc_id';
            $stmt = $this->conn->prepare($sql);
            $stmt->execute([
    ...
    public function deleteCategory($danh_muc_id)
    {
        try {
            ...
            $sql = 'DELETE FROM categories WHERE id = :danh_muc_id';
            $stmt = $this->conn->prepare($sql);
            $stmt->execute([':danh_muc_id' => $danh_muc_id]);
